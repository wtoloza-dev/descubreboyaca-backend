"""Archive repository interfaces (Protocols).

This module defines the protocol interfaces for Archive repository operations.
...
class ArchiveRepositoryProtocol(Protocol):
    """Protocol defining the contract for synchronous Archive repository.
...
class AsyncArchiveRepositoryProtocol(Protocol):
    """Protocol defining the contract for asynchronous Archive repository.
