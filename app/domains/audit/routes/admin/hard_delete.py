...
from app.domains.audit.dependencies import get_archive_service_dependency
from app.domains.audit.schemas.admin import (
...
async def handle_hard_delete_archive(
    ...
    service: Annotated[ArchiveService, Depends(get_archive_service_dependency)],
