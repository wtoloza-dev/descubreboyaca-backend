"""Restaurant PostgreSQL implementation.

This module provides the PostgreSQL repository implementation for Restaurant persistence operations.
...
class PostgreSQLRestaurantRepository(SQLRestaurantRepository):
    """Restaurant PostgreSQL implementation using async operations.
