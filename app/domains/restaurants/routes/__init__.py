...
from app.domains.restaurants.routes.dish import router as dishes_router
from app.domains.restaurants.routes.restaurant import router as restaurants_router
