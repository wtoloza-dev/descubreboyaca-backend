"""Dish creation schemas for owner.

This module contains request and response schemas for the owner create route.
Corresponds to: routes/dish/owner/create.py
"""
...
class CreateDishSchemaResponse(AuditSchema, BaseModel):
    """Response schema for created dish (owner).
