...
This module provides the SQLite repository implementation for User persistence operations.
...
class SQLiteUserRepository(SQLUserRepository):
    """Repository for User entity persistence using SQLite.
    ...
    Attributes:
        session: SQLAlchemy async session for database operations (inherited).
    """
