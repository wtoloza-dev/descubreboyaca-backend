...
This module provides the PostgreSQL repository implementation for Review persistence operations.
...
class PostgreSQLReviewRepository(SQLReviewRepository):
    """Review PostgreSQL implementation using async operations.
